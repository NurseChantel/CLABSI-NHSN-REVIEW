...
function renderSiteGuide() {
 ...
 const usesEvidenceReview = ["BONE", "MEN", "SA"].includes(definition?.siteCode) || definition?.siteCode === "DISC" || definition?.siteCode === "PJI";
