...
function renderSiteGuide() {
 ...
 const usesEvidenceReview = ["BONE", "MEN", "SA"].includes(definition?.siteCode) || definition?.siteCode === "DISC" || definition?.siteCode === "ENDO" || definition?.siteCode === "JNT" || definition?.siteCode === "VASC";
...
function renderCalculatedStatuses() {
  ...
  const attributionUnlocked = !["BONE", "DISC", "ENDO", "MEN", "SA"].includes(state.selectedSite) || site.met;
