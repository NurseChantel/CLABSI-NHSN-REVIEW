...
function renderSiteGuide() {
 ...
 const usesEvidenceReview = ["BONE", "MEN", "SA"].includes(definition?.siteCode) || definition?.siteCode === "MED" || definition?.siteCode === "DISC" || definition?.siteCode === "ENDO" || definition?.siteCode === "JNT";
