...
test("PNU1 remains separate from every Chapter 17 pathway and adds no PNU2/PNU3/VAE definition", () => {
  ...
  assert.equal(files.some(name => /pnu[23]|vae|lung/i.test(name)), false);
});
